...
class StageTwoFlowTest {
    ...
    fun threePrimaryEntriesAreReachableAndActionable() {
        ...
        composeRule.onNodeWithTag("record_toolbar").assertIsDisplayed()
        composeRule.onNodeWithTag("record_visibility_switcher").assertIsDisplayed()
    ...
    fun trueSolarTimeCrossesDoubleHourAndShowsAuditEvidence() {
        ...
        composeRule.onAllNodes(hasText("剑锋金"))
            ...
            .performScrollTo()
            .assertIsDisplayed()
        composeRule.onNodeWithText("十神").performScrollTo().assertIsDisplayed()
        composeRule.onNodeWithTag("basic_chart_shensha")
            .performScrollTo()
            .assertIsDisplayed()
    ...
    fun createSaveSearchAndOpenDetail() {
        ...
        composeRule.onNodeWithTag("owner_feedback_input")
            .performScrollTo()
        ...
        composeRule.onNodeWithText("Stage3 合成命主反馈")
            .performScrollTo()
            .assertIsDisplayed()
        ...
        composeRule.waitUntil(timeoutMillis = 10_000) {
            composeRule.onAllNodes(hasTestTag("notes_time_picker"))
                .fetchSemanticsNodes().isNotEmpty()
        }
        composeRule.onNodeWithText("流年").performClick()
        composeRule.onNodeWithText("确定").performClick()
        composeRule.onAllNodes(hasTestTag("timeline_event_input"))[0]
            .performScrollTo()
