...
class AutomatedPickerFlowTest {
    ...
    fun almanacOpensFromHomeAndSelectedDateReturnsToChart() {
        ...
        composeRule.onNodeWithTag("almanac_relation_attention")
            .performScrollTo()
            .assertIsDisplayed()
        composeRule.onNodeWithText("天干留意").assertIsDisplayed()
        composeRule.onNodeWithText("地支留意").assertIsDisplayed()
