...
- 问真 P0/P1 已支持私有图片复制、bundled 离线 OCR、页面分类、字段/长文本/事件候选、
  原图定位、人工修正、复算和正式提交；真实案例准确率仍须用户批准样本验收，禁止把
  合成夹具结果冒充真实问真保真指标。P2 专业细盘尚未实现。
- Stage 7B/7C 的节气边界、两种子时口径、专业流运合同与岁运页已完成内部证据；
  下一内部增量按需求差距表推进外围能力。问真真实样本、OPPO 与正式发布仍需用户授权。
